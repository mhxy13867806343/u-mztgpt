...
var stdin_default86 = (0, vue_exports.defineComponent)({
  ...
  setup(props, {
    ...
    const id = useId();
    const fieldRef = (0, vue_exports.ref)();
    const onCancel = () => {
      if (!slots.action) {
        emit("update:modelValue", "");
        emit("cancel");
...
var stdin_default107 = (0, vue_exports.defineComponent)({
  ...
  setup(props, {
    ...
    const text = (0, vue_exports.ref)("");
    const expanded = (0, vue_exports.ref)(false);
    const hasAction = (0, vue_exports.ref)(false);
    const root = (0, vue_exports.ref)();
    const pxToNum = (value) => {
      if (!value)
        return 0;
    ...
    const renderAction = () => (0, vue_exports.createVNode)("span", {
      "class": bem96("action"),
      "onClick": onClickAction
    }, [expanded.value ? props.collapseText : props.expandText]);
    (0, vue_exports.onMounted)(calcEllipsised);
    (0, vue_exports.watch)(() => [props.content, props.rows], calcEllipsised);
...
var stdin_default111 = (0, vue_exports.defineComponent)({
  name: name103,
  props: uploaderProps,
  ...
  setup(props, {
    ...
    const renderPreviewItem = (item, index) => {
      ...
      return (0, vue_exports.createVNode)(stdin_default110, (0, vue_exports.mergeProps)({
        "item": item,
        "index": index,
...
export {
  ...
  version,
  install,
  stdin_default115 as stdin_default
};
//# sourceMappingURL=chunk-DYG6KUA6.js.map
